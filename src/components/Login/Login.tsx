...
import "./Login.scss";
import { getAuthLogin } from "../../redux/reducers/authReducer";
        ...
        {({
          ...
          <Form className="auth__items">
            ...
            {touched.email && errors.email && (
              <span className="auth__item_error">{errors.email}</span>
            )}
            <div className="auth__item_login">
            ...
            {touched.password && errors.password && (
              <span className="auth__item_error">{errors.password}</span>
            )}
            <Checkbox
              type="checkbox"
              formik
