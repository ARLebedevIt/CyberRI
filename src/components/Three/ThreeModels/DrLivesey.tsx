...
export function Livesey(props: JSX.IntrinsicElements['group']) {
  ...
  return (
    <group {...props} dispose={null} position={[0, -0.2, 0]} scale={[15, 15, 15]}>
      <group ref={body as unknown as Ref<THREE.Group>}>
        <mesh
          name="Coat"
          geometry={nodes.Coat.geometry}
          material={materials.Livesey}
          morphTargetDictionary={nodes.Coat.morphTargetDictionary}
          morphTargetInfluences={nodes.Coat.morphTargetInfluences}
          position={[0, -1.76, -0.06]}
