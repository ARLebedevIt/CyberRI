          ...
          <div className="cyberRi__description">
            <div className="cyberRi__text">
              <span>
                ...
                Академик Лебедев А.Р. принимает решение обнародовать в массы данные о секретных разработках Советских учёных в
                области компьютерных технологий за период 1950-1960 годы. Помните: все, что вы узнаете дальше, — секретно и
