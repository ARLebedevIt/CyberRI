...
import { getErrorWeatherSelector } from '../../redux/selectors/meteometerSelectors'
import { getWeather } from '../../redux/reducers/meteometerReducer'
import { Page } from '../../ui/Page/Page'
import Meteometer from './Meteometer'
import MeteometerNav, { UnitsTypes } from './MeteometerNav'
...
const MeteometerContainer = React.memo(() => {
  ...
  const setWeather = useCallback((city: string, units: UnitsTypes, setDisable: Dispatch<SetStateAction<boolean>>) => {
