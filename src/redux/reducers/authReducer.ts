...
export const actionsAuth = {
  ...
  getCaptchaUrlSuccess: (captchaUrl: string) => ({ type: 'CRI/AUTH/GET_CAPTCHA_URL_SUCCESS', payload: { captchaUrl } } as const),
  setIsFetching: (isFetching: boolean) => ({ type: 'CRI/AUTH/SET_IS_FETCHING', payload: { isFetching } } as const)
}
