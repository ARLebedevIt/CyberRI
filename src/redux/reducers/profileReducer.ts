...
let initialState = {
  posts: [
    ...
    { id: 2, text: `— Папа, а почему никак не наступит светлое будущее?
    — Как же оно наступит, если оно будущее...`, date: '25 / 12 / 2122 21:56'
    },
...
export const saveDescripton = (descData: DescriptionProfileType, setStatus: (param: string | string[]) => void,
  setSubmitting: (param: boolean) => void,
  setEditMode: (param: boolean) => void): ThunkTypes => async (dispatch, getState) => {
